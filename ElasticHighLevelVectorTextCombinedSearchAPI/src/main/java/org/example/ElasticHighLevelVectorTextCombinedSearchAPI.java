...
public class ElasticHighLevelVectorTextCombinedSearchAPI {
    ...
    private static RestHighLevelClient createClient() {
        ...
        RestClientBuilder builder = RestClient.builder(new HttpHost("ELASTIC-SERVER-IP-ADDRESS", ELASTIC-PORT, "http"))
