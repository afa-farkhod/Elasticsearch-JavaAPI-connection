...
public class search_dmap0002_ST extends search
{
    String rtnVal = "";
                        ...
                        String brmCls1Nm , String brmCls2Nm, String dataSe)
    {
        try
        {
            ...
            request.setRequest(new SearchRequest("dmap_map_treemap_view_detail"));//index

            request.setScriptType(ScriptType.STORED);
            request.setScript("dmap_0002");//script title
            ...
            filterQuery.add(QueryBuilders.termsQuery("brmCls1Nm", brmCls1Nm));
            filterQuery.add(QueryBuilders.termsQuery("brmCls2Nm", brmCls2Nm));
            filterQuery.add(QueryBuilders.termsQuery("dataSe", dataSe));
