...
public class search_dmap0013_ST extends search
{
    String rtnVal = "";
    ...
    public void search(RestHighLevelClient client , SearchSourceBuilder ssb, int page , int size ,
                        String fromDate, String toDate, int aggSize)
    {
        try
        {
            //전처리
            ...
            request.setScript("dmap_0013");//script title
            ...
            if(aggSize!=0) params.put("aggs_size", aggSize);
            ...
            Terms buck1 = searchResponse.getAggregations().get("popular");
