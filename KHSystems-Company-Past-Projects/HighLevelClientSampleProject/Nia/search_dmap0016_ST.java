...
public class search_dmap0016_ST extends search
{
    String rtnVal = "";
                        ...
                        String mtaTblId)
    {
        try
        {
            ...
            request.setRequest(new SearchRequest("dmap_map_meta_info_stdr_tbl"));//index

            request.setScriptType(ScriptType.STORED);
            request.setScript("dmap_0016");//script title
