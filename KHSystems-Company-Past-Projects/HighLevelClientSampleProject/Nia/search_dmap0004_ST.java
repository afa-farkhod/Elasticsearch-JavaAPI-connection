...
public class search_dmap0004_ST extends search
{
    String rtnVal = "";
    ...
    public void search(RestHighLevelClient client , SearchSourceBuilder ssb, int page , int size ,String[] excludeFields,
                        String keyword, String operator, String brmCls1Nm,String orgNm, String openDataYn)
    {
        try
        {
            //전처리
            ...
            request.setScript("dmap_0004");//script title
            ...
            if (operator.equals("") == false) params.put("operator", operator);

            ArrayList<Object> filterQuery = new ArrayList<Object>();
            if (brmCls1Nm.equals("") ==false ) filterQuery.add(QueryBuilders.termsQuery("brmCls1Nm", brmCls1Nm));
            if (orgNm.equals("") ==false ) filterQuery.add(QueryBuilders.termsQuery("orgNm", orgNm));
            if (openDataYn.equals("") ==false ) filterQuery.add(QueryBuilders.termsQuery("openDataYn", openDataYn));
