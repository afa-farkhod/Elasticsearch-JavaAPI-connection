...
public class search_dmap0015_ST extends search
{
    String rtnVal = "";
    ...
    public void search(RestHighLevelClient client , SearchSourceBuilder ssb, int page , int size ,String[] excludeFields,
                        String keyword, String operator, String brmCls1Nm, String orgNm , String[] openScopeOrgCd)
    {
        try
        {
            //전처리
            ...
            request.setScript("dmap_0015");//script title
            ...
            if(openScopeOrgCd.length != 0 ) filterQuery.add(QueryBuilders.termsQuery("openScopeOrgCd", openScopeOrgCd));
