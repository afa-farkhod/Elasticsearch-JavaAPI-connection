...
public class search_dmap0006_ST extends search
{
    String rtnVal = "";
    ...
    public void search(RestHighLevelClient client , SearchSourceBuilder ssb, int page , int size ,String[] excludeFields,
                        String[] docId, String openHoldColList)
    {
        try
        {
            //전처리
            ...
            request.setScript("dmap_0006");//script title
            ...
            params.put("openHoldColList", openHoldColList);
