...
public class search_portal0003_ST extends search
{
    String rtnVal = "";
    ...
    public void search(RestHighLevelClient client , SearchSourceBuilder ssb, int page , int size ,String[] excludeFields)
    {
        try
        {
            ...
            request.setRequest(new SearchRequest("portal_public_instt"));//index

            request.setScriptType(ScriptType.STORED);
            request.setScript("portal_0003"); //script title
