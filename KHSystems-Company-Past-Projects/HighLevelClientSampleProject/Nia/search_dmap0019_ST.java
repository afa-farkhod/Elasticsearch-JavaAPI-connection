...
public class search_dmap0019_ST extends search
{
    String rtnVal = "";
    ...
    public void search(RestHighLevelClient client , SearchSourceBuilder ssb, int page , int size ,String[] excludeFields
                        , String keyword, String operator , int aggsSize)
    {
        try
        {
            //전처리
            ...
            request.setScript("dmap_0019");//script title
            ...
            if (aggsSize!=0) params.put("aggs_size", aggsSize);
            ...
            result.put("resultOrgNmAggsCnt", resultAgg1.size() );   
            result.put("resultOrgNmAggsMsg", resultAgg1);
            result.put("resultBrm1AggsCnt", resultAgg2.size() );   
            result.put("resultBrm1AggsMsg", resultAgg2);
