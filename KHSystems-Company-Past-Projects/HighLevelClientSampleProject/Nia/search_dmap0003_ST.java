...
public class search_dmap0003_ST extends search
{
    String rtnVal = "";
    ...
    public void search(RestHighLevelClient client , SearchSourceBuilder ssb, int page , int size ,String[] excludeFields, String keyword)
    {
        try
        {
            //전처리
            ...
            request.setRequest(new SearchRequest("dmap_map_srch_kwrd_mnage"));//index

            request.setScriptType(ScriptType.STORED);
            request.setScript("dmap_0003");//script title
            ...
            Terms buck1 = searchResponse.getAggregations().get("knwldgSe");
