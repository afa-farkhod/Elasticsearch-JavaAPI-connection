...
public class search_dmap0018_ST extends search
{
    String rtnVal = "";
                        ...
                        , String[] mtaTblId, int aggsSize)
    {
        try
        {
            ...
            Terms buck1 = searchResponse.getAggregations().get("hold_col_list");
            ...
            result.put("resultAggsCnt", resultAgg1.size() );   
