...
public class search_dmap0016_col_ST extends search
{
    String rtnVal = "";
                        ...
                        String mtaTblId, String prsnInfoYn, String encTrgYn, String openDataYn)
    {
        try
        {
            ...
            request.setRequest(new SearchRequest("dmap_map_meta_info_stdr_col"));//index

            request.setScriptType(ScriptType.STORED);
            request.setScript("dmap_0016_col");//script title
            ...
            filterQuery.add(QueryBuilders.termsQuery("mtaTblId", mtaTblId));
            filterQuery.add(QueryBuilders.termsQuery("prsnInfoYn", prsnInfoYn));
            filterQuery.add(QueryBuilders.termsQuery("encTrgYn", encTrgYn));
            filterQuery.add(QueryBuilders.termsQuery("openDataYn", openDataYn));
