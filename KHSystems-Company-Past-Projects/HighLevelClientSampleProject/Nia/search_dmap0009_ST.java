...
public class search_dmap0009_ST extends search
{
    String rtnVal = "";
    ...
    public void search(RestHighLevelClient client , SearchSourceBuilder ssb, int page , int size ,String[] excludeFields,
                        String sort, String sortOrder , String operator,  String keyword)
    {
        try
        {
            //전처리
            ...
            //request.setRequest(new SearchRequest("dmap_map_dictionary_rltd_term"));//index
            request.setRequest(new SearchRequest("dmap_map_ptal_mgr_rltd_tbl"));//index
            
            request.setScriptType(ScriptType.STORED);
            request.setScript("dmap_0009");//script title
